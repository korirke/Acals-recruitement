  ...
  const contactInfo = [
    {
      icon: Mail,
      title: "Email",
      detail: " jobs@acal.co.ke",
      link: "mailto:jobs@acal.co.ke",
    },
    {
      icon: Phone,
      title: "Phone",
      detail: "+254 717 535 337",
      link: "tel:+254717535337",
    },
    {
      icon: MapPin,
      title: "Address",
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="animate-fade-in">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400 mb-8">
                    Reach out to us through any of these channels, and we'll be
                    happy to assist you.
                  </p>
                </div>
                ...
                <Card
                  className="border-neutral-200 dark:border-neutral-800 bg-orange-50 dark:bg-orange-900/20 animate-fade-in"
              ...
              <div className="lg:col-span-2">
                <Card
                  className="animate-fade-in border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900"
